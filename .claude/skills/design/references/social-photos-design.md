...
Design social media images via HTML/CSS rendering + screenshot export. Orchestrates `design-harness`, `brand`, `design-system`, and browser screenshot tooling.
...
3. **`design-harness`** — choose layout, hierarchy, visual balance, and anti-slop constraints. Do not randomize skill choice; vary the concepts deliberately.
